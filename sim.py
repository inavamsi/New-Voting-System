...
class Election():
	counties = 0    #number of counties
	pvotes =0       #number of positve votes per person
	nvotes=0        #number of negative votes per person
	candidate_list=[]  # list of lists, one list per county
	# for a county candidate indexed by county number, list will be numbers from 0..n-1
	voter_list_c =[] # list of lists, one list per county
	...
	def score(self,arg):
		...
		if arg ==1:
			print("Acceptance Index scale -100 to 100")
			print(self.victors)
